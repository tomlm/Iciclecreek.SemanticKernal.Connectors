...
public class FileMemoryBasicFilterTests(FileMemoryBasicFilterTests.Fixture fixture)
    : BasicFilterTests<int>(fixture), IClassFixture<FileMemoryBasicFilterTests.Fixture>
{
