    ...
    where TKey : notnull
{
    ...
    protected virtual async Task Test<TVector>(TVector value,
        ...
        int dimensions = 3,
        [CallerMemberName] string testName = default)
        where TVector : notnull
    {
        vectorEqualityAsserter ??= (e, a) => Assert.Equal(e, a);

        await fixture.VectorStore.EnsureCollectionDeletedAsync(testName);

        var collection = fixture.VectorStore.GetCollection<TKey, Record<TVector>>(testName, fixture.CreateRecordDefinition<TVector>(embeddingGenerator: null, distanceFunction, dimensions));
        ...
        var dynamicCollection = fixture.VectorStore.GetDynamicCollection(testName, fixture.CreateRecordDefinition<TVector>(embeddingGenerator, distanceFunction, dimensions));
        ...
        if (embeddingGenerator is not null)
        {
            ...
            var collection2 = fixture.VectorStore.GetCollection<TKey, RecordWithString>(testName, fixture.CreateRecordDefinition<string>(embeddingGenerator, distanceFunction, dimensions));
